                ...
                <div class="d-flex align-items-baseline">
                  ...
                  ${
                    product.compare_price
                      ? `<span class="product-compare-price">${formatPrice(
                          product.compare_price
                        )}</span>`
                      : ""
                  }
        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="details">
            ...
            <ul>
              ...
              <li><strong>Weight:</strong> ${product.weight_value || "N/A"} ${
    product.weight_unit || ""
  }</li>
          ...
          <div class="tab-pane fade" id="materials">
            ...
            <p>${
              product.care_instructions || "Standard care instructions apply."
            }</p>
          </div>
          ...
          <div class="tab-pane fade" id="sustainability">
            ...
            <p>${
              ...
              "We are committed to sustainable and ethical fashion practices."
            }</p>
            <h6>Production Method</h6>
            <p>${
              product.production_method ||
              "Crafted with care using traditional methods."
            }</p>
            ${
            ...
            .map((size) => {
              ...
              <div class="variant-option ${isSelected ? "selected" : ""} ${
                !isAvailable ? "disabled" : ""
                   ...
                   onclick="${
                     isAvailable ? `selectVariant('size', '${size}')` : ""
                   }">
                ${size}
              </div>
            `;
        ...
        <div class="variant-options">
          ${colors
            .map((color) => {
              ...
              const isAvailable = getAvailableStock(variant) > 0;
              return `
              <div class="variant-option color-variant ${
                isSelected ? "selected" : ""
              } ${!isAvailable ? "disabled" : ""}" 
                   style="background-color: ${variant?.color_hex || "#ccc"}"
                   onclick="${
                     isAvailable ? `selectVariant('color', '${color}')` : ""
                   }"
                   title="${color}">
              </div>
            `;
...
async function loadRelatedProducts() {
  ...
  try {
    ...
    document
      ...
      .insertAdjacentHTML("afterend", relatedSection);
  } catch (error) {
    console.error("Failed to load related products:", error);
  }
}
